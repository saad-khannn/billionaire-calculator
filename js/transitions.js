$(document).ready(function () {
    $("#btn").click(function () { //when "calculate" button is clicked
        ...
        if ($("#user-wealth").length) { $("#user-wealth").fadeIn(1500); } //#user-wealth fades in if element text is loaded
        if ($("#user-rank").length) { $("#user-rank").delay(1500).fadeIn(1500); } //#user-rank fades in if element text is loaded
    });
});
